...
let options = {
    ...
    wsPort: process.env.MIX_PUSHER_APP_PORT ? Number(process.env.MIX_PUSHER_APP_PORT) : 6001,
    wssPort: process.env.MIX_PUSHER_APP_PORT ? Number(process.env.MIX_PUSHER_APP_PORT) : 6001,
    forceTLS: false,
    encrypted: true,
    disableStats: true,
