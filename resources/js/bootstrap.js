...
let options = {
    ...
    wsPort: process.env.MIX_PUSHER_APP_PORT ? process.env.MIX_PUSHER_APP_PORT : 6001,
    wssPort: process.env.MIX_PUSHER_APP_PORT ? process.env.MIX_PUSHER_APP_PORT : 6000,
    forceTLS: false,
    encrypted: true,
    disableStats: true,
