...
<div class="row wrapper border-bottom white-bg page-heading">
    <div class="col-lg-10 col-md-10">
       <h2  style="text-transform:uppercase"><b>Mantenimiento del Mensaje</b></h2>
        <ol class="breadcrumb">
    ...
    <div class="col-lg-2 col-md-2">
        @if($activo==0)
        <a class="btn btn-block btn-w-m btn-primary m-t-md" href="{{route('mensaje.create')}}"  >
            ...
            "columns": [
                ...
                {data: 'mensaje', className:"text-center" },
                {
                    ...
                    render: function (data) {
                        ...
                        //Ruta Modificar
                        var url_edit = '{{ route("mensaje.edit", ":id")}}';
    ...
    function eliminar(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    //Ruta Eliminar
                    var url_eliminar = '{{ route("mensaje.destroy", ":id")}}';
