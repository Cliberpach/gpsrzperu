...
<div class="wrapper wrapper-content animated fadeIn">
    <form class="wizard-big" action="{{ route('mantenimiento.colaborador.create') }}" method="POST" enctype="multipart/form-data" id="form_registrar_empleado">
        ...
        <fieldset style="position:relative;">
            <div class="row">
                 <div class="col-lg-8">
                            ...
                            <div class="form-group col-lg-6 col-xs-12" id="documento_requerido">
                        ...
                        <div class="row">
                            <div class="form-group col-lg-6 col-xs-12" id="fecha_nacimiento">
        ...
        <h1>Direccion del colaborador</h1>
        <fieldset>
            <div class="row">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#fecha_nacimiento .input-group.date,#fecha_inicio_actividad .input-group.date,#fecha_fin_actividad .input-group.date,#fecha_inicio_planilla .input-group.date,#fecha_fin_planilla .input-group.date').datepicker({
                todayBtn: "linked",
